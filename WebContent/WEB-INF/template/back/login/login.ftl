			...
			<table>
				...
				<#if isBackCaptcha>
					<tr>
						...
						<td>
							<input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off" /><img id="captchaImage" class="captchaImage" src="${base}/admin/common/captcha.jhtml?captchaId=${captchaId}" title="${message("admin.captcha.imageTitle")}>" />
						</td>
					</tr>
				</#if>
				<tr>
