...
import com.hyeb.dao.ArticleDao;
import com.hyeb.dao.ProductDao;
...
public class SearchServiceImpl implements SearchService {
	...
	/** 模糊查询最小相似度 */
	private static final int FUZZY_QUERY_MINIMUM_SIMILARITY = 50;
	...
	public Page<Article> search(String keyword, Pageable pageable) {
		...
		try {
			...
			fullTextQuery.setSort(new Sort(new SortField[] { new SortField("isTop", SortField.Type.STRING, true), new SortField(null, SortField.Type.SCORE), new SortField("createDate", SortField.Type.LONG, true) }));
